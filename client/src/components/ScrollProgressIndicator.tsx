...
export default function ScrollProgressIndicator() {
  ...
  return (
    <>
      ...
      <button
        onClick={scrollToTop}
        className={`fixed bottom-6 right-6 bg-primary/90 hover:bg-primary text-white p-3 rounded-full shadow-lg z-50 transition-all duration-300 overflow-hidden group ${
          showScrollToTop 
